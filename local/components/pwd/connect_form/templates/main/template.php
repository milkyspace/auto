...
<h3 id="one_click" class="request_text">Оставьте заявку, чтобы получить бесплатную консультацию</h3>
<img src="/local/asset/img/svg/boy.svg" class="boy_pic" style="float: right ;
